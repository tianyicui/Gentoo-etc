...
set gentoo_user_vm = "${HOME}/.gentoo/Users/tianyi/Gentoo/java-config-2/current-user-vm"
set gentoo_system_vm = "/Users/tianyi/Gentoo"/etc/java-config-2/current-system-vm
